...
export default function CardFlip({
  ...
  const [codeBlockStyles] = useState(() =>
    Array.from({ length: 6 }, () => ({
      ...
      >
        ...
        >
          ...
          <div className="absolute inset-0 flex items-center justify-center pt-20">
            <div className="relative flex h-[100px] w-[200px] flex-col items-center justify-center gap-2" suppressHydrationWarning>
              {/* Code blocks animation */}
              {isMounted && codeBlockStyles.map((style, i) => (
                <div
                  key={i}
                  className={cn(
