          ...
          >
            <div className="relative">
              <Textarea
                ...
                value={value}
                placeholder=""
                className="w-full rounded-2xl rounded-b-none px-4 py-1.5 bg-black/5 dark:bg-white/5 border-none dark:text-white resize-none focus-visible:ring-0 leading-[1.2] text-sm min-h-0"
                ref={textareaRef}
                onKeyDown={(e) => {
