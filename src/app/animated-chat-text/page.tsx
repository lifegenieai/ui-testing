...
export default function AnimatedChatTextPage() {
  return (
    <div className="container mx-auto p-8 space-y-12">
      <div className="space-y-4">
        <h1 className="text-4xl font-bold">Animated Chat Text</h1>
        <p className="text-muted-foreground">
          Interactive demonstrations of text animation with different granularities.
        </p>
      </div>
      ...
      <div className="space-y-8">
        <section className="space-y-4">
          <div>
            <h2 className="text-2xl font-semibold mb-2">Chunk to Character Animation</h2>
            <p className="text-sm text-muted-foreground">
              Left side animates by paragraphs (chunks), right side animates character-by-character.
            </p>
          </div>
        ...
        <section className="space-y-4">
          <div>
            <h2 className="text-2xl font-semibold mb-2">Chunk to Word Animation</h2>
            <p className="text-sm text-muted-foreground">
              Left side animates by paragraphs (chunks), right side animates word-by-word.
            </p>
          </div>
          <ChunkToWordDemo />
        </section>
